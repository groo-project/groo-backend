...
import com.x1.groo.diary.command.domain.repository.DiaryDraftRepository;
...
public class DiaryDraftServiceImpl implements DiaryDraftService {
    ...
    @Override
    @Transactional
    public DiaryDraftInfoResponseDTO existsDraftByDate(int userId, LocalDate date, int forestId) {
        return diaryDraftRepository.findByUserIdAndDiaryDateAndForestId(userId, date, forestId)
    ...
    @Override
    @Transactional
    public int getTotalDraftCount(int userId, int forestId) {
        return diaryDraftRepository.countByUserIdAndForestId(userId, forestId);
    }
    ...
    @Override
    @Transactional
    public List<DiaryDraftListResponseDTO> getDrafts(int userId, int forestId) {
        return diaryDraftRepository.findAllByUserIdAndForestId(userId, forestId);
    }
