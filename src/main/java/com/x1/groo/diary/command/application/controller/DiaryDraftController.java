package com.x1.groo.diary.command.application.controller;
...
import com.x1.groo.diary.command.application.service.DiaryDraftService;
...
public class DiaryDraftController {
    ...
    public ResponseEntity<DiaryDraftInfoResponseDTO> isDraftExist(
            ...
            @RequestParam(name = "forestId") int forestId
            ) {
        DiaryDraftInfoResponseDTO draft = diaryDraftService.existsDraftByDate(user.getUserId(), date, forestId);
    ...
    public ResponseEntity<Integer> getDraftCount(
        ...
        int count = diaryDraftService.getTotalDraftCount(user.getUserId(), forestId);
    ...
    public ResponseEntity<List<DiaryDraftListResponseDTO>> getDrafts(
        ...
        List<DiaryDraftListResponseDTO> drafts = diaryDraftService.getDrafts(user.getUserId(), forestId);
